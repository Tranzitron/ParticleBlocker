...
public class PBConfig extends Config {
    ...
    @Switch(name = "Master Switch", size = OptionSize.DUAL, description = "Toggles ParticleBlocker Mod")
    public static boolean masterSwitch = false;
    @Switch(name = "logs", size = OptionSize.DUAL, description = "Toggle All Logs")
    public static boolean logs = false;


    public PBConfig(){
        //TODO Create Icon & Add It
        super(new Mod("My Mod", ModType.UTIL_QOL), "ParticleBlocker.json");
